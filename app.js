...
const a_plus = new Type({type: "A+",name:"Aplus" ,quantity: 50, donate: ["A+","AB+"], receive: ["A+","A-","O+","O-"]});
const b_plus = new Type({type: "B+",name:"Bplus", quantity: 50, donate: ["B+","AB+"], receive: ["B+","B-","O+","O-"]});
const ab_plus = new Type({type: "AB+",name:"ABplus", quantity: 50, donate: ["AB+"], receive: ["A+","B+","AB+","O+","A-","B-","AB-","O-"]});
const o_plus = new Type({type: "O+",name:"Oplus", quantity: 50, donate: ["A+","B+","AB+","O+"], receive: ["O+","O-"]});
const a_minus = new Type({type: "A-",name:"Aminus" ,quantity: 50, donate: ["A+","A-","AB+","AB-"], receive: ["A-","O-"]});
const b_minus = new Type({type: "B-",name:"Bminus", quantity: 50, donate: ["B+","B-","AB+","AB-"], receive: ["B-","O-"]});
const ab_minus = new Type({type: "AB-",name:"ABminus", quantity: 50, donate: ["AB+","AB-"], receive: ["A-","B-","AB-","O-"]});
const o_minus = new Type({type: "O-",name:"Ominus", quantity: 50, donate: ["A+","B+","AB+","O+","A-","B-","AB-","O-"], receive: ["O-"]});
...
app.post("/giveBlood",async function(req,res){
  res.render("bloodList",{blood_list: ["A+","B+"]});
});
